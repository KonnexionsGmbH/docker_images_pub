...
| Component         | Version                | Remark                           | Status |
|-------------------|------------------------|----------------------------------|--------|
| asdf              | v0.10.2-7e7a1fa        | base version                     |        | 
| curl              | 7.68.0                 | base version                     |        | 
| DBeaver           | 22.1.0                 | for virtual machine only         |        | 
| Docker Desktop    | 20.10.17               | base version [Docker Image & VM] |        | 
...
| Component         | Version                | Remark                           | Status  |
|-------------------|------------------------|----------------------------------|---------|
| asdf              | v0.10.2-7e7a1fa        | base version                     | upgrade | 
| curl              | 7.68.0                 | base version                     |         | 
| DBeaver           | 22.1.0                 | for virtual machine only         | upgrade | 
